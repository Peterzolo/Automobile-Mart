...
vehicleRouter.post('/create',getAuthorize, catchErrors(vehicleController.postCreateVehicle));
...
vehicleRouter.get('/get-one/:id', catchErrors(vehicleController.postGetAVehicle));
